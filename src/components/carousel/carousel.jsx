...
export default function CarouselHero() {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: "Faites vous livrez partout et en toute sérénité",
      bg: assets.carousel3,
      buttonText: "Explore",
      buttonLink: "#",
    },
    {
      title: "Jusqu’à -70% de reduction pour vos achats",
      description: "Commencez vos achats : collections, high-tech, mode...",
      bg: assets.carousel4,
